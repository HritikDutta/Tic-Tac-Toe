...
set includes=/I dependencies\Glad\include /I dependencies\GLFW\include /I src /I dependencies\stb\include /I dependencies\tiny\include
...
cl /EHsc /c dependencies\tiny\src\*.cpp /I dependencies\tiny\include
